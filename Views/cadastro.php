                ...
                <div class="form-group col-md-12">
                    <div class="col-md-7">
                        <div class="input-group input-group-md">
                            ...
                            <input class="form-control" placeholder="Usuario" autofocus aria-describedby="sizing-addon1"
                    ...
                    <div class="col-md-5">
                        <div class="input-group input-group-md">
                            ...
                            <input type="password" class="form-control" placeholder="Senha"
                                   aria-describedby="sizing-addon1" name="password" required>
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-7" id="registro-academico">
                        <div class="input-group input-group-md">
                            ...
                            <input class="form-control" name="acad-reg" placeholder="Registro Acadêmico"
                    ...
                    <div class="col-md-7" id="registro-universitario">
                        <div class="input-group input-group-md">
                            ...
                            <input type="text" class="form-control" name="univ-reg" placeholder="Registro Universitário"
                                   aria-describedby="sizing-addon1">
                        </div>
                    </div>
                </div>
